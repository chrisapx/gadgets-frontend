...
const Sound = () => {
    ...
    return(
        <div style={{height: 400, width: 260, backgroundColor: 'white', padding: 16, marginTop: 40, marginLeft: 10, marginRight: 10}} >
            ...
            <div 
                style={{color: seeMoreHover? 'orange' : 'grey', textDecoration: seeMoreHover? 'underline': 'unset', textDecorationColor: 'orange', fontSize: 12, cursor: "pointer", marginTop: 16, }} onMouseOver={() => setSeeMoreHoover(true)} onMouseOut={() => setSeeMoreHoover(false)} onClick={() => alert("Clicked see more sound accessories")}>See more deals</div>
