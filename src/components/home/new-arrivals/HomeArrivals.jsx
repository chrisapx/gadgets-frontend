...
const HomeArrivals = () => {
    ...
    return(
        <div style={{height: 400, width: 280, backgroundColor: 'white', padding: 16, marginLeft: 10, marginTop: 20,  marginRight: 10, borderRadius: 10}} >
            <title>Home arrivals</title>

            <div style={{color: 'black', fontWeight: '600', fontSize: 19, alignItems: "center", display: "flex", flexDirection: 'column', justifyContent: 'space-between'}}>Arrivals for Home</div> 
