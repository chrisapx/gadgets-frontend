...
const Fitness = () => {
    ...
    return(
        <div style={{height: 400, width: 280, backgroundColor: 'white', padding: 16, marginLeft: 10, marginRight: 10, marginTop: 20,  borderRadius: 10}} >
            ...
            <div style={{color: 'black', fontWeight: '600', fontSize: 19, alignItems: "center", display: "flex", flexDirection: 'column', justifyContent: 'space-between', backgroundColor: 'grey'}}>Fitness deals</div> 
